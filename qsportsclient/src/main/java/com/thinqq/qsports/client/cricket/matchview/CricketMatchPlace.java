 ...
 */
public class CricketMatchPlace extends Place {
	...
	public CricketMatchPlace(String token) {
		this.name = token;
	}
	 ...
	 */
	public static class Tokenizer implements PlaceTokenizer<CricketMatchPlace> {

		@Override
		public String getToken(CricketMatchPlace place) {
			return place.getName();
		}

		@Override
		public CricketMatchPlace getPlace(String token) {
			return new CricketMatchPlace(token);
		}
