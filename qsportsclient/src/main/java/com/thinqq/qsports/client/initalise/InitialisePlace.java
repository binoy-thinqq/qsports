 ...
 */
public class InitialisePlace extends Place {
	...
	public InitialisePlace(String token) {
		this.name = token;
	}
	 ...
	 */
	public static class Tokenizer implements PlaceTokenizer<InitialisePlace> {

		@Override
		public String getToken(InitialisePlace place) {
			return place.getName();
		}

		@Override
		public InitialisePlace getPlace(String token) {
			return new InitialisePlace(token);
		}
