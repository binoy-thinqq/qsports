...
public class TextCell extends
    AbstractInputCell<String, TextCell.ViewData> {

  interface Template extends SafeHtmlTemplates {
    @Template("<input type=\"text\" value=\"{0}\" tabindex=\"-1\" size=\"{1}px\"></input>")
  ...
  /**
   * Constructs a TextCell that renders its text without HTML markup.
   */
  public TextCell(int size) {
    super("change", "keyup");
  ...
  public void render(Context context, String value, SafeHtmlBuilder sb) {
    ...
    if (s != null) {
      ...
      sb.appendHtmlConstant("<input type=\"text\" tabindex=\"-1\" width=\"" + size +"px\"></input>");
    }
  }
