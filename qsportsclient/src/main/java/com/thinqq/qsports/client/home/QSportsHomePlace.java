 ...
 */
public class QSportsHomePlace extends Place {
	...
	public QSportsHomePlace(String token) {
		this.name = token;
	}
	 ...
	 */
	public static class Tokenizer implements PlaceTokenizer<QSportsHomePlace> {

		@Override
		public String getToken(QSportsHomePlace place) {
			return place.getName();
		}

		@Override
		public QSportsHomePlace getPlace(String token) {
			return new QSportsHomePlace(token);
		}
