 ...
 */
public class QSportsWirePlace extends Place {
	...
	public QSportsWirePlace(String token) {
		this.name = token;
	}
	 ...
	 */
	public static class Tokenizer implements PlaceTokenizer<QSportsWirePlace> {

		@Override
		public String getToken(QSportsWirePlace place) {
			return place.getName();
		}

		@Override
		public QSportsWirePlace getPlace(String token) {
			return new QSportsWirePlace(token);
		}
